...
const GeneratoraudioTool = () => {
  ...
  return (
    <div className="container mx-auto px-4 sm:px-8 lg:px-16 xl:px-36 h-auto mt-20 lg:mt-44">
      <div className="border-2 p-4 py-10 bg-gray-100">
        <div className="flex flex-col">
          ...
          ></textarea>
          <p
            className={`text-sm mt-2 ${wordCount > 1500 ? "text-red-500" : "text-gray-500"}`}
          >
  ...
  <div className="flex flex-col">
    <label className="text-lg font-semibold text-gray-700 mb-1">Voice Upload</label>
    <label
      htmlFor="audioUpload"
  ...
  <div className="flex flex-col">
    <Box
      ...
      autoComplete="off"
    >
      <label className="text-lg font-semibold text-gray-700 mb-1">Voice Speed</label>
      <TextField
  ...
  <div className="flex flex-col">
    <Box
      ...
      autoComplete="off"
    >
      <label className="text-lg font-semibold text-gray-700 mb-1">Select Language</label>
      <TextField
