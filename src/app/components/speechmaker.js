  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 sm:px-8 mt-4  h-screen  ">
        <div className="border-2 p-4 py-4 bg-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:gap-20 gap-4 mt-2 md:px-6">
            ...
            <div className="flex flex-col">
              ...
              <label
                htmlFor="audioUpload"
                className="cursor-pointer flex gap-2 bg-blue-500 text-white px-9 py-3 rounded-md hover:bg-blue-600"
              >
                <UploadIcon />
                Upload
                <input
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 md:px-6">
              <Button
                ...
                className="w-full sm:w-auto py-2 mb-1"
              >
                Convert Audio
              </Button>
